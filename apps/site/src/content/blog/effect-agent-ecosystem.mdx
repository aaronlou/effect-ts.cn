---
title: 2026 年，Effect-TS 正在成为 AI Agent 的下一种工程范式吗？
description: 基于 GitHub 开源生态的第一次调查：在 4,861 个仓库里，只有 33 个 TypeScript Agent 真正在用 Effect（3.9%）。但 33 个里有 23 个把它当作 Runtime 地基 —— 这不是范式，却是一种很重的用法。
date: 2026-09-14
draft: false
original: true
authors: [ecn-observatory]
tags: [AI Agent, 生态调查, Effect, 数据研究]
---

> 数据快照：2026-09-14 · 数据集 v0.1
> 在线数据面板：[/observatory/](/observatory/) · 口径与偏差声明：[docs/observatory/methodology.md](https://github.com/aaronlou/effect-ts.cn/blob/main/docs/observatory/methodology.md)
>
> **本文的一切数字都从数据集现算，不手抄。** 判定标准是"下载整个仓库、只统计确实 import 了 effect 的文件"，
> 不是看 README 也不是看 package.json——理由见第 4 章。
